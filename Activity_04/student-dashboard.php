...
<body>
    <aside class="sidebar">
        <div class="sidebar-header">
            ...
            <h2 class="system-name">Ashesi University Attendance System</h2>
        </div>
        ...
        <ul class="sidebar-menu">
            <li><a href="#" onclick="showSection('enrolled')">My Enrolled Courses</a></li>
    ...
    <main class="main-content">
        ...
        <section id="enrolled" class="content-section active">
